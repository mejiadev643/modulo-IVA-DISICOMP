		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Edición de cliente o proveedor
				</p>
			</div>
		</section>
									...
									<div class="mdl-grid">
										...
										<input type="hidden" name="IDCLIENTE" value="<?php echo $clienteproveedor->IDCLIENTE; ?>" />
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="[0-9]+" id="codigocliente" name="CODCLIENT" value="<?php echo $clienteproveedor->CODCLIENT; ?>" title="Digite código sin guión">
