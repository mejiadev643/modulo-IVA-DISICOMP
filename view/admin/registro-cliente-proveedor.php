								...
								<form action="registro-usuario.php" method="post">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											<h5 class="text-condensedLight">Ingresar datos del nuevo Cliente o Proveedor</h5>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="codigocliente" name="CODCLIENT" title="Digite código sin guión">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="Denominacion" name="NOMBCLIENT" title="Digite la denominación">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="registro" name="REGCLIENT" title="Digite registro de cliente">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="giro" name="GIRONEG" title="Digite el giro de su negocio">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="nit" name="NUMNIT" title="Digite su numero de nit">
												<label class="mdl-textfield__label" for="nit">Numero de Nit</label>
												<span class="mdl-textfield__error">Invalid numero de nit</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="telefono" name="TELEFONO" title="Digite su numero teléfono">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="direccion" name="DIRNEG" title="Digite la dirección del negocio">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="tipocliente" name="TIPOCLIENT" title="Digite 1=cliente, 2=proveedor">
												<label class="mdl-textfield__label" for="tipocliente">Tipo de cliente</label>
												<span class="mdl-textfield__error">Invalid tipo de cliente</span>
											</div>
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="tipodocumento" name="TIPODOCUCRFCOF" title="Digite 1=consumidor final, 2=crédito fiscal">
												<label class="mdl-textfield__label" for="tipodocumento">Tipo de documento</label>
												<span class="mdl-textfield__error">Invalid tipo de documento</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="nombrenit" name="NOMBRENIT" title="Digite su nombre segun nit">
